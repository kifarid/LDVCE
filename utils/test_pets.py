...
sd_transform = transforms.Compose(transform_list)
dataset = torchvision.datasets.OxfordIIITPet(root=data_dir, split="test", target_types="category", transform=sd_transform, download=True)
