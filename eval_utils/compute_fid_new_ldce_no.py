...
if __name__ == "__main__":
    ...
    parser.add_argument('--output-path', type=str, default='/misc/lmbraid21/faridk/LDCE_w382_cc23/', help='the path of the experiment')
    parser.add_argument('--sfid', action="store_true")
    parser.add_argument('--drop_mismatch', default=True, type=bool, help='drop mismatched pairs')
